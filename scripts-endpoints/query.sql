...
CREATE TABLE `USUARIOS_LOCALES` (
  `USER_LOCAL_ID` int NOT NULL auto_increment,
  `LOCAL_ID` int NOT NULL,
  `USER_ID` int NOT NULL, 
  PRIMARY KEY (`USER_LOCAL_ID`), 
  CONSTRAINT `FK_USUARIOSLOCALES_USUARIO` FOREIGN KEY (`USER_ID`) REFERENCES `usuarios` (`USER_ID`),
  CONSTRAINT `FK_USUARIOSLOCALES_LOCAL` FOREIGN KEY (`LOCAL_ID`) REFERENCES `locales` (`LOCAL_ID`)
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
